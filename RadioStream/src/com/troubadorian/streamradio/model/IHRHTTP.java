...
import com.troubadorian.streamradio.client.model.IHRHTTPConnection;
import com.troubadorian.streamradio.client.model.IHRURLEncoder;

/*
A IHRHTTP object interacts with HTTP servers.

For Streamradio, there are several different ways HTTP
...
2.  Asynchronous requests for audio data from a Shoutcast
	...
	The current release of Streamradio does not cache audio data.
...
3.	Asynchronous requests which obtain data that is not
	...
	One of the design goals of Streamradio is to present the
...
4.	Asynchronous requests which do not obtain data.
	...
	Streamradio reports statistics on ad impressions by sending
