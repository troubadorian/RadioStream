...
import com.troubadorian.streamradio.client.view.IHRViewBanner;

public class IHRAdvert extends IHRObject {
	...
	protected static IHRAdvert				sSingleton;

	public static IHRAdvert shared() {
		if ( sSingleton == null ) sSingleton = new IHRAdvert();
				...
				switch ( mType ) {
					case kAdTypeBanner: {
						...
						if ( mHandlerBanner != null ) {
							mHandlerBanner.sendMessage( mHandlerBanner.obtainMessage( kMessageAdAcquired, mType, 0, IHRAdvert.this ) );
						}
					} break;
...
//						Log.d( "@@ ad" , IHRUtilities.description( hash ) );
						...
						if ( mHandlerPlayer != null ) {
							mHandlerPlayer.sendMessage( mHandlerPlayer.obtainMessage( kMessageAdAcquired, mType, 0, IHRAdvert.this ) );
						}
					} break;
				}
			} catch ( Exception e ) {
