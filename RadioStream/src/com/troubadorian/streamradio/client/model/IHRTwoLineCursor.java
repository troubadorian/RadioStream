...
{
    final String[] kColumns =
    { "line1", "line2" };

    final int[] kColumnsID =
    { R.id.StationsListRowTextLine1, R.id.StationsListRowTextLine2 };
    ...
    {
        return getColumnIndexIn(arg0, kColumns);
    }

    @Override
    public String getColumnName(int arg0)
    {
        return (arg0 >= 0 && arg0 < kColumns.length) ? kColumns[arg0] : null;
    }
    ...
    {
        return new SimpleCursorAdapter(inContext, kResourceID, this, kColumns,
                kColumnsID);
    }
}
