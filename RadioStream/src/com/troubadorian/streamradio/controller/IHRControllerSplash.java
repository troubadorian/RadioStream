...
import com.troubadorian.streamradio.client.view.IHRViewSplash;
...
public class IHRControllerSplash extends IHRController implements Runnable {
	...
	protected void restoreState( Bundle inState ) {
		mSplashShown = inState.getBoolean( "Streamradio.splash_shown" );
		mViewSplash.mStatus.setText( inState.getCharSequence( "Streamradio.splash_status" ) );
	}
	...
	protected void onSaveInstanceState( Bundle ioState ) {
		...
		ioState.putBoolean( "Streamradio.splash_shown" , mSplashShown );
		ioState.putCharSequence( "Streamradio.splash_status" , mViewSplash.mStatus.getText() );
	}
	...
	public void askOptimization() {
		...
		new SplashDialog( "For optimal performance please close other applications before running Streamradio." , "OK" , null , "Dont Show Again" ) {
	...
	/*public void askLocationDialog() {
		new SplashDialog( "Streamradio would like to use Your Current Location" , "Don't Allow" , null , "OK" ) {
